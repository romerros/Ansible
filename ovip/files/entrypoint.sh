...
if [ ! -e /var/www/html/shopware.php ]; then
    ...
    && unzip -d /var/www/html /tmp/official-vip-shop-5.2-b48cabbd8600fbdf93600dfe1aebac7f1f5e030d.zip \
    && mv -v /var/www/html/official-vip-shop-5.2-b48cabbd8600fbdf93600dfe1aebac7f1f5e030d/* /var/www/html/ \
    && rm -rf /var/www/html/official-vip-shop-5.2-b48cabbd8600fbdf93600dfe1aebac7f1f5e030d || exit 1
    echo "done"
fi
